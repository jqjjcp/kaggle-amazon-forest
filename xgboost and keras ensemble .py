...
train_path = "C:/PycharmProjects/test-jpg/test-jpg"
test_path = "C:/PycharmProjects/test-jpg/test-jpg"
train = pd.read_csv("C:/train_v2.csv")
test = pd.read_csv("C:/sample_submission_v2.csv")
